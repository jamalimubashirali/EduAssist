...
import { QuizType } from 'common/enums';
...
export class QuizzesController {
  ...
  async getOrCreateTopicQuiz(
    ...
    try {
      ...
      if (!savedQuiz) {
        console.error('❌ [SAVE] Failed to create quiz');
      ...
      const response = {
        ...
        _id: savedQuiz._id.toString(), // Add _id for backend compatibility
        title: savedQuiz.title,
        subject: request.subjectId,
        subjectId: request.subjectId, // Add subjectId field
        topicId: savedQuiz.topicId,
        difficulty: savedQuiz.quizDifficulty,
        quizDifficulty: savedQuiz.quizDifficulty, // Add quizDifficulty field
